...
namespace GestorDeEstudantesT6
{
    internal class Estudante
    {
        ...
        public bool inserirEstudante(string nome, string sobrenome, DateTime nascimento, string genero, string telefone, 
            string endereco, MemoryStream foto)
        {
            MySqlCommand comando = new MySqlCommand("INSERT INTO `estudantes`(`nome`, `sobrenome`, `nascimento`, `genero`, `telefone`, `endereco`, `foto`) VALUES (@nome,@sobrenome,@nascimento,@genero,@telefone,@endereco,@foto,[value-8])", meuBancoDeDados.getConexao);
